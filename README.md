...
The latest version: 5.2.30. Please use `Maven Central` link above to get the client.
...
| rp.keystore.resource         | String   | JKS Keystore file path to be used in HTTPS communication                                                                                                                                                                                                                                                                                                                     | No           |
| rp.keystore.password         | String   | Access password for JKS (certificate storage) package, mentioned above                                                                                                                                                                                                                                                                                                       | No           |
| rp.truststore.resource       | String   | JKS Truststore file path to be used in HTTPS communication                                                                                                                                                                                                                                                                                                                   | No           |
| rp.truststore.password       | String   | Access password for JKS (certificate storage) package, mentioned above                                                                                                                                                                                                                                                                                                       | No           |
